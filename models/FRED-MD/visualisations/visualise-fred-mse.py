...
#!/usr/bin/env python3
# USAGE: ./visualise-fred-mse.py <DESIGN_MATRIX>.csv config.yaml predictions-1.csv predictions-2.csv ... 
...
print(Xs.shape)
IP_targets = Xs[first_prediction_day+1:,5] 
print(IP_targets[:6])
...
fig_ratio.write_image("plot_ratio.pdf")
fig_metric.write_image("plot_metric.pdf")
